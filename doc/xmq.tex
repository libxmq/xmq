...
\shifttext{-20mm}{\raisebox{-11.5cm}{\smash{\rotatebox{90}{\rule{55mm}{0.5pt}\ \texttt{LEXER}\ \rule{40mm}{.5pt}}}}}
\hbox{
...
\begin{rail}
  ...
  |'"' 'UTF8 with json escapes' '"'
  |'<' 'UTF8 balanced XML/HTML' '>'
\end{rail}
\end{minipage}
