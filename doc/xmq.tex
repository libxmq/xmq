...
{\color{Red}\texttt{Specification for XMQ by Fredrik Öhrström 2023-12-18 \texttt{oehrstroem@gmail.com}}}
...
\hbox{
  ...
  \end{minipage}
  \ \ \
  \raisebox{-4pt}{\hspace{-1em}\texttt{all-spaces:}}
  \begin{minipage}{5cm}
    \begin{rail}
      '0x9 0xa 0xd unicode categories WS Zs'
    \end{rail}
  \end{minipage}
}
...
\verb|r6. All leading and ending spaces 0x20 and newlines 0xa are removed.| \\
\verb|r7. All spaces before a newline are removed.| \\
\verb|r8. Incidental indentation (some spaces 0x20 after a newline) is removed.|\\
...
\texttt{The tab 0x9 is not in WS since its variable size would confuse incindental indentation.}\\
...
Quote starting with quote characters: \xmqLP\ \xmqE{\#39;} \xmqQuote{'quoted quote'}\ \xmqE{\#39;} \xmqRP\ or: \\
\xmqQ\xmqQ\xmqQ\\
