...
\xmqI \xmqI \xmqI \xmqI \xmqEN{shipto}(\xmqAK{sailing})\linebreak
...
\xmqI \xmqI \xmqI \xmqI \xmqI \xmqI \xmqI \xmqI \xmqEK{code}\xmqI \xmqI =\xmqI \xmqEKV{"}\xmqEKV{regSale({'}container{'},123);}\xmqEKV{"}\linebreak
\xmqI \xmqI \xmqI \xmqI \}\linebreak
\}
}
\end{minipage}
...
\POS{20mm}{-27mm}{\begin{picture}(10,10)\vector(-1,-1){4}\put(1,0){\emph{single and double quotes that need to be quoted}}\end{picture}}%
\POS{8mm}{-12mm}{\begin{picture}(10,10)\vector(-1,1){4}\put(-2,-3){\emph{n+1 quotes to quote n quotes (cave! empty string is 2 quotes)}}\end{picture}}%
\POS{3mm}{-66mm}{\begin{picture}(10,10)\vector(-1,1){4}\put(-2,-3){\emph{double quotes mirror single quotes}}\end{picture}}%
...
\vspace{-7mm}
\texttt{\flushleft\noindent \xmqEN{shiporder}\{\xmqEK{id}=\xmqEKV{889923} \xmqEK{type}=\xmqEKV{container} \xmqEN{shipto}(\xmqAK{sailing})\{\xmqEK{address}=\xmqCP{(}\xmqEKV{'The Vasa Museum'}\xmqE{\&\#10;}\xmqEKV{'Galärvarvsvägen 14'}\xmqE{\&\#10;}\xmqEKV{'115 21 Stockholm'}\xmqE{\&\#10;}\xmqEKV{'Sweden'}\xmqCP{)}\xmqC{/*Remember to verify coord.*/}\xmqEK{coord}=\xmqEKV{'''59°19'41.0"N 18°05'29.0"E'''}\xmqEK{code}=\xmqEKV{"regSale('container',123);"}\}\}
}
...
Value with leading/ending single quotes: \xmqEK{x} \xmqEq\ \xmqQ{"'quoted quote'"}\ \\
or: \xmqEK{x} \xmqEq\ \xmqLP\ \xmqE{\#39;} \xmqQ{'quoted quote'}\ \xmqE{\#39;} \xmqRP\ or: \\
\xmqQu\xmqQu\xmqQu\\
\xmqQ{'quoted quote'}\\
\xmqQu\xmqQu\xmqQu \\
